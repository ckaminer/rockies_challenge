...
# generate plots!
plotly.offline.plot(hc_right_fig, filename='hc-right-sinker-scatter')
plotly.offline.plot(hc_left_fig, filename='hc-left-sinker-scatter')
plotly.offline.plot(pc_right_fig, filename='pc-right-sinker-scatter')
plotly.offline.plot(pc_left_fig, filename='pc-left-sinker-scatter')
plotly.offline.plot(neutral_right_fig, filename='neutral-right-sinker-scatter')
plotly.offline.plot(neutral_left_fig, filename='neutral-left-sinker-scatter')
