...
# generate plots!
plotly.offline.plot(hc_right_fig, filename='hc-right-curve-scatter')
plotly.offline.plot(hc_left_fig, filename='hc-left-curve-scatter')
plotly.offline.plot(pc_right_fig, filename='pc-right-curve-scatter')
plotly.offline.plot(pc_left_fig, filename='pc-left-curve-scatter')
plotly.offline.plot(neutral_right_fig, filename='neutral-right-curve-scatter')
plotly.offline.plot(neutral_left_fig, filename='neutral-left-curve-scatter')
