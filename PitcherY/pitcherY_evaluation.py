...
for i in range(2, 110):
    ...
    strikeout_BB = y_data.cell(row=i, column=18).value
    hit_type = y_data.cell(row=i, column=20).value
    out_on_play = y_data.cell(row=i, column=21).value
    run_on_play = y_data.cell(row=i, column=22).value
    plate_appearance = y_data.cell(row=i, column=2).value
    previous_appearance = y_data.cell(row=i-1, column=2).value
